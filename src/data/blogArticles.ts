export type BlogArticle = {
  ...
  /** Old Wix URL path (without domain) for 301 redirects */
  wixSlug?: string;
  content: string; // Markdown-ish body content
};

export const blogArticles: BlogArticle[] = [
  // ─── Migrated from Wix ────────────────────────────────────────────
  {
    slug: "surviving-spouse-homestead-rights-renting-texas",
    title:
    ...
    readTime: "3 min read",
    metaDescription:
      "Can a surviving spouse lose their homestead rights by renting out the property in Texas? Learn how abandonment, renting, and intention to return affect your rights.",
    wixSlug:
      "can-a-surviving-spouse-lose-their-homestead-rights-by-renting-out-the-property-in-texas",
    content: `In a particularly poignant case, a client found herself in a challenging situation following the death of her spouse. As part of a blended family, she was unaware that her husband's interest in their property had passed to his children from a previous relationship. This detail came to light years later when, due to her advancing age and health concerns, she decided to move to an assisted living facility for better care and support.

However, this decision led to unexpected legal complications. The children initiated a lawsuit to partition the property, arguing that by moving out, she had effectively abandoned her homestead rights. The case hinged on the critical question of whether her departure constituted an intention to leave the property, thereby relinquishing her homestead rights permanently.

The court's deliberation focused on the concept of abandonment, which in Texas requires clear evidence of a homeowner's intention not to return to their homestead. In this case, the court found that her move to an assisted living facility, driven by her inability to live independently, indicated a lack of intention to return to the homestead. It wasn't merely a choice to live elsewhere; it was a necessity borne out of health needs, which ultimately led to the court's decision that she had abandoned her homestead rights.

As a result, the property was ordered to be sold, a decision that starkly illustrates the complex interplay between homestead rights, the intentions of the homeowner, and the legal interpretations of abandonment. This case serves as a cautionary tale for surviving spouses, especially in blended families, highlighting the importance of understanding the implications of moving from a homestead property and how such actions can affect their rights and interests.

## Understanding Homestead Rights and the Impact of Renting on Surviving Spouses

Can a surviving spouse lose their homestead rights by renting out the property in Texas? Yes. However, it is not as simple as renting out the property. Homestead rights are a cornerstone of Texas property law, offering protection to homeowners by safeguarding their primary residence from certain types of creditors and providing surviving spouses with the right to occupy the homestead after their partner's death. However, these rights come with specific conditions, especially when it comes to renting the property. For surviving spouses, navigating these rules is crucial to maintaining their homestead rights and avoiding unintentional abandonment of the property.

## The Essence of Homestead Protection

Homestead protection in Texas is designed to ensure that a surviving spouse can continue living in the family home without fear of displacement. **This protection remains effective until the spouse either abandons the property, passes away, or voluntarily transfers (alienates) the property.** Evidence of abandonment must be clear and unmistakable, demonstrating a total and intentional relinquishment of the property without plans to return and reclaim the homestead exemption.

## Renting and Homestead Rights: A Delicate Balance

A common misconception is that renting out a homestead property automatically results in the loss of homestead rights. However, the law is more nuanced. The act of renting does not, in itself, forfeit a homesteader's right to use and occupy. Indeed, the Texas legal framework permits the leasing of homestead property under certain conditions without constituting abandonment.

## Intention to Return: The Key Factor

The critical element in maintaining homestead rights while renting the property is the intention of the homesteader to return. Physical absence from the property does not equate to abandonment, provided there's a clear intention to return and reoccupy the premises as the primary residence. This intention can be demonstrated through various means, such as keeping personal belongings on the property, maintaining utility services, or other actions indicating plans to return.

## Legal Implications of Establishing a New Homestead

Legally, establishing a new homestead is considered abandonment of the former, as it reflects a clear intention to make another property the primary residence. Courts look for definitive acts, such as designating a new property as a homestead for tax purposes or moving to and occupying another residence, to determine whether the old homestead has been abandoned.

## Protecting Your Rights: Precautions and Considerations

For surviving spouses or homesteaders considering renting out their property, it's essential to navigate these legal waters carefully to avoid unintended consequences. Consulting with a legal professional can provide guidance tailored to individual circumstances, ensuring that actions like renting out a homestead do not inadvertently lead to the loss of valuable rights.

Moreover, understanding the nuances of pre-marital agreements and their potential to waive homestead rights is critical. Clear and convincing evidence of informed consent is required to waive these protections, emphasizing the importance of legal advice in these situations.

## Conclusion

Texas homestead laws offer robust protection for homeowners and surviving spouses, but they also require a careful approach to renting and property management. By understanding the legal landscape and taking informed actions, homesteaders can protect their rights and ensure their home remains a sanctuary for years to come.`,
  },
  {
    slug: "indiana-requirements-valid-will",
    title: "Indiana's Requirements to Create a Valid Will",
    excerpt:
...
It's crucial to consult with an attorney familiar with Indiana's estate planning laws when creating a will. This ensures that your wishes are accurately and legally documented and that your assets are distributed according to your intentions. Laws and regulations can change, so always check for the most up-to-date information or consult with a legal professional.`,
  ...
  {
    slug: "revoking-transfer-on-death-deeds-texas",
    title: "A Guide on Revoking a Transfer on Death Deed in Texas",
    excerpt:
    ...
    readTime: "3 min read",
    metaDescription:
      "Step-by-step guide to revoking a Transfer on Death Deed in Texas. Learn the legal process, requirements, and common questions about TODD revocation.",
    wixSlug: "a-guide-on-revoking-a-transfer-on-death-deeds-in-texas",
    content: `A Transfer on Death Deed (TODD) is a powerful estate planning tool in Texas, allowing property owners to designate beneficiaries for real estate without going through probate. However, life circumstances change, and you may need to revoke a previously filed TODD. This guide provides a detailed, step-by-step process on how to revoke a TODD in Texas, ensuring your actions are legally binding and effective.
...
### Step 1: Understand the Legal Basis for Revocation
...
### Step 3: Sign and Notarize the Instrument of Revocation
...
### Step 4: File the Revocation with the County Clerk
...
### Step 5: Notify Interested Parties (Optional but Recommended)
...
**Can I revoke a TODD if the beneficiary doesn't agree?**
Yes, you can revoke a TODD without the beneficiary's consent or knowledge.

**Does revoking a TODD affect my current ownership of the property?**
No, revoking a TODD does not affect your current ownership or rights to the property.

**Can I revoke a TODD if I've lost the original document?**
...
For personalized assistance with revoking a TODD or other estate planning needs, consult with an experienced estate and probate attorney. They can provide expert guidance, ensuring your legal documents are correctly prepared and recorded, and that your estate planning goals are achieved in compliance with Texas law.`,
  ...
  {
    slug: "introducing-posterity-planning",
    title:
    ...
    readTime: "2 min read",
    metaDescription:
      "Discover posterity planning -- a new approach to estate planning that goes beyond wealth transfer to create opportunities for future generations. Learn how intentional trusts can support education, personal growth, and security.",
    wixSlug:
      "introducing-posterity-planning-a-new-approach-to-estate-planning",
    content: `Have you ever thought about estate planning in terms of creating opportunities, not just transferring assets? Today, I want to introduce a concept that might shift the way you think about planning for the future.
...
What are you waiting for? Let's get this done.`,
  ...
  {
    slug: "navigating-probate-without-attorney-texas",
    title:
    ...
    readTime: "3 min read",
    metaDescription:
      "Wondering if you can handle probate without an attorney in Texas? In some cases, like using a Muniment of Title or transferring assets with an Affidavit of Heirship, probate may be possible without legal representation.",
    wixSlug:
      "navigating-probate-without-an-attorney-what-you-need-to-know",
    content: `Probate can be a daunting process, and many people wonder if they can handle it without hiring an attorney. While it is sometimes possible, there are specific situations and legal requirements to consider. This guide explores when and how you might avoid hiring an attorney during probate, especially in Texas.

## Why Is an Attorney Needed for Probate?

In most cases, hiring an attorney is necessary during probate because courts generally require legal representation when dealing with third parties. Here's why:

**Representation Rules**
- You can only represent yourself in court.
- An estate is considered a separate legal entity, similar to a corporation. Representing an estate requires a law license, just as representing another person (e.g., a spouse) does.

**Legal Complexities**
- Filing court paperwork and managing estate administration involve navigating legal procedures that often require expertise.

## Situations Where You Might Not Need an Attorney

There are limited scenarios where a court may allow you to handle probate without an attorney.

### Muniment of Title

In Texas, if the decedent left a valid will, a **Muniment of Title** may be available under Texas Estates Code Section 257.001. This process is simpler because:
- It avoids creating a full estate administration.
- It focuses on transferring title to the beneficiaries named in the will.
- It can be used even when there are multiple beneficiaries.

However, this option is only available if there are no unpaid debts other than debts secured by liens on real property (such as a mortgage). If the estate has unsecured debts, a full administration may be necessary.

## Avoiding Probate for Different Types of Property

The type of property involved determines whether probate can be avoided:

### Personal Property

**What is Personal Property?**
Personal property includes tangible and intangible assets not attached to a specific location, such as jewelry, cars, and other movable items.

**When Probate is Not Necessary**
If all beneficiaries agree on how to distribute the personal property and there are no creditors, probate may not be required.

**Special Cases for Titled Personal Property**
For items like cars, you may still need to provide documentation, such as an **Affidavit of Heirship**, to transfer ownership without formal probate. Note that an Affidavit of Heirship is primarily used when someone dies without a will (intestate). If a will exists, other probate tools like Muniment of Title are typically more appropriate.

### Real Property (Real Estate)

**Why Real Property is Tricky**
Transferring ownership of real estate typically requires formal probate unless you take specific steps to simplify the process.

**How to Avoid Probate for Real Property**
The key is working with a **title company**. Some title companies will insure and transfer property if provided with sufficient documentation, such as an Affidavit of Heirship.

**Consulting a Title Company**
Title companies may have varying requirements. It's essential to consult with them early to determine whether they will insure the transfer without probate.

## Final Thoughts on Navigating Probate Without an Attorney

Probating an estate without an attorney is possible in certain situations, but it requires a clear understanding of the property type, legal requirements, and available alternatives.

If you're considering navigating probate on your own:

- Ensure all beneficiaries agree on property distribution.
- Consult with a title company for real estate matters.
- Be prepared to provide necessary documentation like an Affidavit of Heirship.

For complex cases or when in doubt, hiring an attorney can save time and reduce the risk of errors.`,
  },
  {
    slug: "legal-tip-dont-sue-for-5000",
    title:
    ...
    readTime: "3 min read",
    metaDescription:
      "Legal Tip of the Day: Not every fight is worth it. Find out why skipping a $5,000 lawsuit and investing your energy elsewhere could be the best decision you make.",
    wixSlug:
      "legal-tip-of-the-day-don-t-sue-for-5-000-build-something-instead",
    content: `As a lawyer, what I'm about to say might seem counterintuitive -- but it's a perspective that I've seen change lives:
...
A **piece of paper** called a **judgment**. That judgment says they owe you $5,000. That's it. Unless the person owns property or has accessible assets, collecting that money can be like chasing the wind. You might file an abstract of judgment to put a lien on future property sales, but the reality is **most individuals who aren't paying you probably don't have the money to begin with**.
...
One of my clients was in this exact situation. I advised him: "Take the 40 hours you'd spend trying to sue this person and go out and sell what you already know how to sell."
...
## Shift from Conflict to Creation
...
And if you ever do need to sue, we're here to help you do it wisely.`,
  },
  {
    slug: "estate-plan-vacation-ready-summer-refresh",
    title:
    ...
    readTime: "2 min read",
    metaDescription:
      "Is your estate plan still working for you? Take a few minutes this summer to ensure your will, POA, and asset titles are in order for peace of mind.",
    wixSlug:
      "is-your-estate-plan-vacation-ready-here-s-your-3-step-summer-refresh",
    content: `Summer is a season for sunshine, adventure, and family -- but it's also a good time to pause and ask:
...
Estate planning isn't just for the end of life -- it's for all the moments in between. Whether you're hopping on a plane, hitting the lake, or staying local this summer, the peace of mind that comes from knowing your affairs are in order is worth every second.`,
  ...
  {
    slug: "why-trusts-are-essential-estate-planning",
    title: "Why Trusts Are Essential in Estate Planning",
    excerpt:
    ...
    readTime: "5 min read",
    metaDescription:
      "Learn about the role and benefits of trusts in estate planning, and discover how they can protect your assets and ensure your wishes are fulfilled.",
    wixSlug: "why-trusts-are-essential-in-estate-planning",
    content: `When it comes to securing your family's future, estate planning is a crucial step. One of the most effective tools in this process is the use of estate planning trusts. These legal arrangements offer peace of mind by ensuring your assets are managed and distributed according to your wishes. In this post, I want to walk you through why estate planning trusts are so important, especially if you want to protect your legacy and provide for your loved ones in McKinney, Texas.

Estate planning trusts are more than just legal jargon. They are practical solutions that help you avoid common pitfalls like probate delays, high taxes, and family disputes. By understanding how trusts work and their benefits, you can make informed decisions that safeguard your assets and simplify the transfer process.

## Understanding Estate Planning Trusts and Their Benefits

Estate planning trusts are legal entities that hold and manage your assets during your lifetime and beyond. Unlike a will, which only takes effect after death, trusts can provide ongoing management and control. This is especially helpful if you want to protect assets for minor children, family members with special needs, or beneficiaries who may not be financially responsible.

Here are some key benefits of estate planning trusts:

- **Avoiding Probate**: Trusts allow your estate to bypass the often lengthy and costly probate process. This means your beneficiaries can receive their inheritance faster and with less hassle.
- **Privacy**: Unlike wills, which become public record, trusts remain private. This keeps your financial affairs confidential.
- **Control Over Distribution**: You can specify exactly how and when your assets are distributed. For example, you might set conditions for beneficiaries to receive funds at certain ages or milestones.
- **Tax Advantages**: Certain types of trusts, particularly irrevocable trusts, can help reduce estate and gift taxes for high-net-worth families. Texas has no state estate or inheritance tax, but federal estate tax may apply to estates exceeding the federal exemption threshold.
- **Protection from Creditors**: Irrevocable trusts can shield assets from creditors or legal claims, providing an extra layer of security. Note that revocable trusts generally do not provide creditor protection during the grantor's lifetime.

For families in McKinney, Texas, where property values and family businesses may be significant, these benefits are especially valuable. A well-crafted trust can ensure your hard-earned assets are protected and passed on smoothly.

## What Is the True Meaning of Trust?

When we talk about estate planning trusts, it's important to understand what a trust really means in this context. A trust is a legal arrangement where one party, known as the trustee, holds and manages assets for the benefit of another, called the beneficiary. The person who creates the trust is the grantor or settlor.

The essence of a trust lies in this relationship of confidence and responsibility. The trustee has a fiduciary duty to manage the assets prudently and in the best interest of the beneficiaries. This means acting with honesty, care, and loyalty.

Trusts can be tailored to fit many different needs:

- **Revocable Trusts**: These can be changed or revoked by the grantor during their lifetime. They offer flexibility and control.
- **Irrevocable Trusts**: Once established, these cannot be changed. They provide stronger protection against taxes and creditors.
- **Special Needs Trusts**: Designed to provide for beneficiaries with disabilities without affecting their government benefits.
- **Charitable Trusts**: Allow you to support causes you care about while receiving tax benefits.

Understanding these distinctions helps you choose the right trust for your unique situation. It's not just about legal protection; it's about creating a plan that reflects your values and goals.

## How Estate Planning Trusts Protect Your Family and Assets

One of the most reassuring aspects of estate planning trusts is their ability to protect your family and assets from unexpected challenges. Life is unpredictable, and having a trust in place can provide stability during difficult times.

For example, if you have young children, a trust can appoint a guardian and ensure funds are available for their care and education. This avoids the need for court intervention and guarantees your wishes are followed.

If you own a family business, a trust can help manage the transition smoothly. It can set rules for how the business is run and who inherits it, preventing disputes among heirs.

Trusts also protect your assets from creditors and lawsuits. By placing assets in certain types of trusts, you can shield them from claims, ensuring your family's financial security.

Moreover, trusts can help manage your affairs if you become incapacitated. A successor trustee can step in to handle your finances without the need for a court-appointed guardian or conservator.

## Practical Steps to Establishing an Estate Planning Trust

Creating an estate planning trust might seem overwhelming, but breaking it down into manageable steps makes the process straightforward. Here's how you can get started:

1. **Assess Your Assets and Goals**: Take stock of your property, investments, and other valuables. Think about what you want to achieve with your estate plan.
2. **Choose the Type of Trust**: Based on your goals, decide whether a revocable, irrevocable, or specialized trust fits your needs.
3. **Select a Trustee**: This person or institution will manage the trust. Choose someone trustworthy and capable.
4. **Draft the Trust Document**: Work with an experienced estate planning attorney to create a legally sound document that outlines the terms and conditions.
5. **Fund the Trust**: Transfer ownership of your assets into the trust. This step is crucial for the trust to be effective.
6. **Review and Update Regularly**: Life changes, and so should your trust. Regular reviews ensure it remains aligned with your wishes.

By following these steps, you can create a solid foundation for your estate plan that offers peace of mind and security.

## Why You Should Consult a Local Estate Planning Attorney

Navigating estate planning trusts requires expertise, especially when considering Texas laws and local regulations. Consulting a knowledgeable attorney in McKinney ensures your plan complies with state requirements and addresses your specific circumstances.

Estate planning trusts are powerful tools that offer control, protection, and peace of mind. By understanding their benefits and working with trusted professionals, you can ensure your assets are preserved and your loved ones are cared for. Remember, planning ahead is the best gift you can give to those you cherish most.`,
  },
  {
    slug: "why-every-texan-needs-medical-power-of-attorney",
    title: "Why Every Texan Needs a Medical Power of Attorney",
    excerpt:
    ...
    readTime: "3 min read",
    metaDescription:
      "Discover how a medical power of attorney ensures your healthcare decisions are respected when you cannot make them yourself.",
    wixSlug: "why-every-texan-needs-a-medical-power-of-attorney",
    content: `When planning for the future, especially when it comes to your health and well-being, having clear instructions in place is essential. One of the most important tools in estate planning is a **Medical Power of Attorney**. This document allows you to appoint someone you trust to make healthcare decisions on your behalf if you become unable to do so. In this post, we'll walk you through the essentials of Texas medical directives, explain how they work, and offer practical advice on securing your wishes with confidence.

## What Are Medical Directives in Texas?

In Texas, "medical directives" refer to legal documents that outline your healthcare preferences and appoint someone to act on your behalf if you cannot. They include:

- **Medical Power of Attorney (MPOA):** Appoints a trusted person -- called your agent -- to make healthcare decisions when you're unable to communicate.
- **Directive to Physicians and Family or Surrogates (Living Will):** States whether you want life-sustaining treatment if you are diagnosed with a terminal or irreversible condition.
- **Out-of-Hospital Do Not Resuscitate (DNR) Order:** Instructs emergency personnel not to attempt resuscitation outside of a hospital setting.

Together, these directives ensure that your voice is heard even when you cannot speak for yourself. Without them, your family may face confusion, conflict, or even a court process to appoint a guardian before decisions can be made.

## Why a Medical Power of Attorney Matters in Estate Planning

Estate planning is not only about distributing assets -- it's also about protecting your health and dignity. A Medical Power of Attorney plays a vital role by giving a person you trust the authority to speak for you if you cannot.

Imagine being hospitalized and unable to communicate. Without an MPOA:
- Doctors may have to wait for a court-appointed guardian.
- Family members could disagree over your care.
- Decisions may be delayed or made in ways that don't reflect your wishes.

With an MPOA, your chosen agent can immediately speak with doctors, review treatment options, and ensure your care aligns with your values.

**Key benefits include:**
- Peace of mind knowing your healthcare decisions are in trusted hands.
- Clear guidance for doctors and family members.
- Avoidance of family conflict.
- Faster decision-making in emergencies.

## How to Get a Medical Power of Attorney in Texas

If you live in McKinney -- or anywhere in Texas -- obtaining a Medical Power of Attorney is straightforward. Texas law provides a statutory form to make sure your wishes are legally recognized.

**Steps to Create a Texas Medical Power of Attorney:**

1. **Choose Your Agent** -- Select someone you trust to make healthcare decisions in line with your values.
2. **Use the Texas Statutory Form** -- The official "Medical Power of Attorney" form is authorized by Chapter 166 of the Texas Health & Safety Code.
3. **Sign Before Two Witnesses** -- You must sign in front of two qualified adult witnesses, who must also sign the document. Witnesses cannot be your agent, your healthcare provider, an employee of your healthcare provider, someone who has a claim against your estate, or someone who benefits from your estate. Notarization is optional but recommended in addition to the required witnesses.
4. **Distribute Copies** -- Provide a copy to your agent, family, and doctors. Keep one in an accessible place.
5. **Review and Update** -- Review your MPOA regularly, especially after major life events, to ensure it reflects your current wishes.

## Practical Tips for Choosing Your Healthcare Agent

Choosing the right person to act as your healthcare agent is one of the most important steps you'll take. Consider these qualities:

- **Trustworthiness:** They must act in your best interest.
- **Good Communication:** They should be comfortable speaking with doctors and family.
- **Availability:** Choose someone who can step in quickly if needed.
- **Understanding of Your Wishes:** Discuss your values openly.
- **Willingness to Serve:** Confirm they are comfortable with this responsibility.

It's also wise to name a backup agent in case your first choice is unavailable.

## Protecting Your Legacy with Comprehensive Estate Planning

A Medical Power of Attorney is just one part of a strong estate plan. Alongside wills, trusts, and financial powers of attorney, it ensures your health, assets, and loved ones are protected.

## Take the Next Step

Planning ahead is one of the greatest gifts you can give your family. Don't wait until a crisis -- set up your medical directives now.`,
  },
  {
    slug: "hiring-trust-will-attorney-key-timing",
    title: "When to Contact a Trust Attorney",
    excerpt:
    ...
    readTime: "4 min read",
    metaDescription:
      "Find out when and why to engage a trust and will attorney for personalized estate solutions.",
    wixSlug: "hiring-a-trust-and-will-attorney-key-timing",
    content: `Planning your estate is one of the most thoughtful steps you can take to protect your family and your assets. But knowing **when** to hire a trust attorney can feel overwhelming. You want to make sure your wishes are clear, your loved ones are cared for, and your legacy is secure. Timing plays a crucial role in this process. Acting too late can cause unnecessary stress and complications, while acting too early might feel premature. Let's explore the key moments when reaching out to a trust and will attorney makes the most sense.

## Understanding Trust Attorney Timing: Why It Matters

Timing your engagement with a trust attorney is about more than just paperwork. It's about ensuring your estate plan reflects your current life situation and future goals. Life changes like marriage, the birth of a child, or acquiring significant assets often signal the right time to consult a professional.

For example, if you recently bought a home or started a business, these assets need protection. A trust attorney can help you create a living trust that avoids probate and keeps your affairs private. On the other hand, if you're approaching retirement or have health concerns, it's wise to act sooner rather than later. This ensures your healthcare directives and powers of attorney are in place.

**Key signs it's time to hire a trust attorney:**

- You've experienced a major life event (marriage, divorce, birth, death)
- You've acquired new assets or investments
- You want to avoid probate and simplify estate transfer
- You want to protect minor children or dependents
- You're planning for potential incapacity or long-term care

## How to Know the Right Moment

Knowing when to hire a trust attorney can feel like a balancing act. You want to be proactive but not rushed. Here are some practical tips to help you decide:

1. **Review your current estate plan annually.** Life changes quickly. Even if you have a will or trust, it's important to revisit it regularly.
2. **Watch for changes in laws.** Estate laws can change, affecting how your assets are handled. A trust attorney stays updated and can advise you accordingly.
3. **Consider your family dynamics.** If you have blended families, special needs dependents, or complicated relationships, early legal guidance is essential.
4. **Plan before major life events.** Before marriage, divorce, or retirement, consult a trust attorney to adjust your plans.
5. **Don't wait for a crisis.** Waiting until illness or incapacity can limit your options and increase stress for your family.

By paying attention to these factors, you can find the right moment to engage a trust attorney and avoid last-minute decisions.

## Practical Steps to Take When Hiring a Trust Attorney

Once you decide the timing is right, here's how to move forward smoothly:

- **Gather your financial information.** List your assets, debts, insurance policies, and beneficiary designations.
- **Identify your goals.** Think about who you want to inherit your assets, who will manage your trust, and any special instructions.
- **Prepare questions.** Ask about the attorney's experience, fees, and how they handle updates or changes.
- **Schedule a consultation.** Many attorneys offer initial meetings to discuss your needs and explain the process.
- **Review and sign documents carefully.** Make sure you understand each part of your trust and related documents before signing.

Remember, a good trust attorney will guide you patiently and clearly. They will help you feel confident that your estate plan reflects your wishes and protects your loved ones.

## Why Early Planning Benefits You and Your Family

Starting your estate planning early has many advantages. It reduces stress, avoids family conflicts, and ensures your assets are distributed according to your wishes. Early planning also allows you to:

- **Make thoughtful decisions.** You have time to consider your options without pressure.
- **Update plans as life changes.** Your trust can evolve with your circumstances.
- **Protect your privacy.** Trusts avoid public probate proceedings.
- **Provide for minor children or dependents.** You can appoint guardians and trustees.
- **Plan for incapacity.** Powers of attorney and healthcare directives ensure your wishes are respected.

By hiring a trust attorney at the right time, you create a solid foundation for your family's future.

Taking the step to hire a trust and will attorney is a meaningful way to protect what matters most. Whether you're just starting to think about estate planning or updating an existing plan, timing is key. Act with intention, seek expert guidance, and enjoy the peace of mind that comes with knowing your legacy is secure.`,
  },

  // ─── New articles (planned for Lawwg.com) ─────────────────────────
  {
    ...
    readTime: "4 min read",
    metaDescription:
      "A will does not avoid probate in Texas. Learn the difference between wills and trusts, and what McKinney and Southlake families need to know about the probate process.",
    content: `One of the most common misconceptions we encounter at WG Law is the belief that having a will means your estate will avoid probate. Unfortunately, that's not how it works in Texas -- or in any other state.
...
A will is a valuable document, but it does not avoid probate. If keeping your family out of court is important to you, a trust-based estate plan is the more effective path. Contact WG Law to discuss which approach makes sense for your family's situation.`,
  },
  {
    ...
    readTime: "4 min read",
    metaDescription:
      "Dying without a will in Texas doesn't mean your spouse inherits everything. Learn how Texas intestacy laws divide community and separate property.",
    content: `"If something happens to me, my spouse gets everything anyway, right?"
...
If you haven't created an estate plan yet -- or if your plan hasn't been updated in a few years -- contact WG Law to schedule a consultation. It's one of the most important things you can do for the people you love.`,
  },
  {
    ...
    readTime: "3 min read",
    metaDescription:
      "When your child turns 18, you lose the legal right to make their medical decisions. Learn why a medical power of attorney is the most important graduation gift in Texas.",
    content: `Graduation season is filled with celebrations, gifts, and excitement about the future. But there's one gift that almost no one thinks to give -- and it might be the most important one of all.

**A Medical Power of Attorney.**

When your child turns 18, something significant changes under the law: they become a legal adult. That means you -- as their parent -- **no longer have the automatic right to make medical decisions for them**, access their medical records, or even speak with their doctors without their permission.

## Why This Matters More Than You Think

Most parents don't realize this until they're in a situation where it matters. Imagine your 18-year-old is away at college and:

- They're in a car accident and unconscious in the ER
- They have an allergic reaction and can't communicate
- They need emergency surgery and someone needs to authorize it

Without a Medical Power of Attorney, the hospital may not be able to speak with you about their condition or let you make decisions on their behalf. You could be left waiting in the dark while doctors follow default protocols.

## What Is a Medical Power of Attorney?

A Medical Power of Attorney (MPOA) is a legal document that allows your child to designate someone -- typically a parent -- as their healthcare agent. This agent can:

- Communicate with doctors and access medical records
- Make treatment decisions if the child is incapacitated
- Authorize or refuse medical procedures
- Ensure the child's wishes are followed

In Texas, the MPOA is governed by Chapter 166 of the Health & Safety Code. It's a straightforward document, but it must be properly executed to be valid.

## What Documents Should Every 18-Year-Old Have?

We recommend a simple package of three documents for every young adult:

### 1. Medical Power of Attorney
Designates who can make healthcare decisions. This is the most critical document.

### 2. HIPAA Authorization
Allows designated individuals to access medical records and communicate with healthcare providers. Even with an MPOA, a separate HIPAA release ensures smoother communication.

### 3. Statutory Durable Power of Attorney
Covers financial decisions -- like paying bills, managing a bank account, or handling insurance claims -- if your child is incapacitated.

## It's Not Just for Emergencies

These documents aren't just for worst-case scenarios. They're practical for everyday situations too:

- Calling the doctor's office about a prescription
- Handling insurance paperwork while your child is at school
- Managing a minor medical procedure when your child is out of state

## The Conversation to Have

Talking about medical documents with your 18-year-old doesn't have to be heavy or scary. Frame it as a practical step -- just like getting a driver's license or setting up a bank account. It's part of becoming an adult.

Here's a simple way to start: "Now that you're 18, the hospital can't talk to me about your health without your permission. Let's set up a quick document so I can help if you ever need me to."

## A Gift That Truly Protects

Cards and cash are great. A watch or a piece of jewelry is meaningful. But a Medical Power of Attorney? That's a gift that says: *I will always be here to take care of you, even when the law says I can't.*

At WG Law, we help families across McKinney, Southlake, and North Texas prepare these documents quickly and affordably. Contact us to set up your graduate's essential medical documents before they head off to their next chapter.`,
  },

  // ─── New articles — filling practice-area gaps + core depth ───────
  {
    slug: "parent-can-no-longer-live-alone-texas",
    title:
    ...
    readTime: "4 min read",
    metaDescription:
      "When a parent can no longer live alone in Texas, families face difficult choices. Learn about guardianship, powers of attorney, Medicaid, and care planning options.",
    content: `One of the most difficult conversations a family can have is admitting that a parent can no longer safely live on their own. Maybe there have been falls. Maybe bills are going unpaid. Maybe a doctor has raised concerns about memory or judgment.

Whatever the trigger, the question is the same: **what do we do now?**

At WG Law, we work with North Texas families navigating this transition every week. Here's a practical guide to the legal tools and decisions you'll face.

## Step 1: Assess the Situation Honestly

Before making legal moves, take stock of what's actually happening:

- **Physical safety**: Can your parent prepare meals, bathe, manage medications, and move around the home safely?
- **Cognitive function**: Are there signs of confusion, memory loss, or poor judgment?
- **Financial management**: Are bills being paid? Is your parent vulnerable to scams?
- **Social isolation**: Has your parent withdrawn from activities, church, or friends?

The answers determine whether you need help with daily tasks, financial management, medical decisions, or all of the above.

## Step 2: Check for Existing Legal Documents

The first legal question is whether your parent already has estate planning documents in place. Look for:

- **Statutory Durable Power of Attorney** -- This allows a designated agent to manage finances, pay bills, and handle property transactions. In Texas, the word "durable" means it remains effective even if the principal becomes incapacitated.
- **Medical Power of Attorney** -- Allows an agent to make healthcare decisions if the principal cannot communicate their wishes.
- **Directive to Physicians (Living Will)** -- States preferences about life-sustaining treatment.

If these documents exist and are current, your family may already have the legal authority needed to help. If they don't exist, time is critical -- these documents can only be signed while your parent still has mental capacity.

## Step 3: If There Are No Documents -- Consider Guardianship

When a parent lacks capacity and has no power of attorney in place, Texas law requires a court to appoint a guardian. This process, governed by the Texas Estates Code, involves:

- Filing an application with the county court
- A court-appointed attorney to represent your parent's interests
- A medical evaluation or physician's letter
- A hearing where the judge determines whether guardianship is necessary

Guardianship can be **full** (the guardian controls all personal and financial decisions) or **limited** (the court restricts authority to specific areas). Texas courts prefer the least restrictive option that still protects the individual.

**Guardianship is time-consuming and expensive.** It typically costs several thousand dollars and takes weeks to months. This is why we strongly recommend that families put powers of attorney in place before a crisis hits.

## Step 4: Understand the Care Options

Once you have legal authority, the next question is where and how your parent will receive care:

- **In-home care**: A caregiver comes to your parent's home. This ranges from a few hours a week to 24/7 care.
- **Assisted living**: A residential facility that provides meals, medication management, and daily assistance.
- **Memory care**: Specialized facilities for individuals with Alzheimer's or dementia.
- **Nursing home (skilled nursing)**: The highest level of care, often needed after hospitalization or for complex medical needs.

Each option has different costs, and those costs matter for Medicaid planning -- which brings us to the financial side.

## Step 5: Plan for the Financial Reality

Long-term care in Texas is expensive. Assisted living averages $4,000 to $6,000 per month. Nursing home care can exceed $7,000 to $10,000 per month.

Most families cannot sustain these costs indefinitely from savings alone. The primary options for paying for care include:

- **Private pay** from savings, retirement accounts, or family contributions
- **Long-term care insurance** (if your parent purchased a policy)
- **Veterans benefits** (Aid and Attendance for qualifying veterans or surviving spouses)
- **Texas Medicaid** for nursing home care (subject to strict income and asset limits)

Medicaid planning requires careful attention to the five-year look-back period, exempt assets (like a homestead), and spend-down strategies. Starting this process early can save families tens of thousands of dollars.

## Don't Wait for a Crisis

The single most important piece of advice we give families: **do not wait until a hospital stay or emergency to start planning.** The legal and financial tools available to you are far more effective -- and far less expensive -- when put in place before a crisis.

If you're noticing signs that a parent needs more help, contact WG Law to discuss your family's options. We'll help you understand what legal authority you need, what care options make sense, and how to protect your parent's assets and dignity.`,
  },
  {
    slug: "texas-medicaid-five-year-look-back",
    title:
...
At WG Law, we help North Texas families develop Medicaid planning strategies that comply with the law while preserving as much wealth as possible for the family. If you have a parent approaching the age where long-term care may be needed, the time to start planning is now.`,
  ...
  {
    slug: "protect-home-from-medicaid-texas",
    title:
    ...
    readTime: "4 min read",
    metaDescription:
      "Learn how to protect your home from Medicaid in Texas. Understand homestead exemptions, estate recovery, and legal strategies to preserve your property for your family.",
    content: `For most Texas families, the home is the single largest asset. When a spouse or parent needs nursing home care and Medicaid becomes part of the conversation, one of the first questions is always: **"Will we lose the house?"**
...
Protecting your home from Medicaid requires planning -- not last-minute paperwork. The earlier you start, the more options you have. At WG Law, we help families across McKinney, Southlake, and North Texas develop strategies that protect the homestead while ensuring access to the care benefits your family needs.`,
  ...
  {
    slug: "uncontested-divorce-texas-guide",
    title:
    ...
    readTime: "4 min read",
    metaDescription:
      "Learn about uncontested divorce in Texas -- what it costs, how long it takes, residency requirements, and what you need to agree on before filing.",
    content: `Divorce is never easy, but it doesn't always have to be a drawn-out battle. When both spouses agree on the major issues -- property division, child custody, support -- Texas law provides a streamlined path called an **uncontested divorce**.
...
Even in an uncontested divorce, having an attorney draft and review the paperwork protects you from costly mistakes -- like failing to divide a retirement account properly or leaving ambiguous custody language. We handle the legal work so you can focus on moving forward.`,
  },
  {
    ...
    readTime: "4 min read",
    metaDescription:
      "LLC vs. Corporation in Texas: understand the legal, tax, and liability differences to choose the right business structure for your company.",
    content: `Starting a business in Texas is exciting, but one of the first legal decisions you'll face is also one of the most important: **should you form an LLC or a corporation?**
...
Choosing the wrong business structure can cost you thousands in unnecessary taxes or create liability gaps you didn't anticipate. At WG Law, we help entrepreneurs and small business owners in McKinney and North Texas choose the right structure, file the paperwork, and set up the foundational documents -- operating agreements, bylaws, and resolutions -- that protect your business from day one.`,
  ...
  {
    slug: "guardianship-texas-when-needed-how-works",
    title:
...
If your family is facing a guardianship situation, or if you want to put documents in place to avoid one, contact WG Law. We'll help you find the path that best protects your loved one.`,
  ...
  {
    slug: "executor-duties-texas-step-by-step",
    title:
    ...
    readTime: "4 min read",
    metaDescription:
      "Named as executor of a Texas estate? Learn your duties step by step -- from filing the will to distributing assets and closing the estate.",
    content: `Being named as the executor of someone's will is an honor, but it's also a significant responsibility. Many people don't realize what the role actually involves until they're in the middle of it -- often while grieving the loss of a loved one.
...
Texas law allows executors to hire attorneys, accountants, and other professionals to assist with estate administration -- and the estate pays for these services. At WG Law, we guide executors through every step of the probate process, from filing the will to distributing the final assets.`,
  ...
  {
    slug: "blended-families-estate-planning-texas",
    title:
...
At WG Law, we help blended families in McKinney, Southlake, and North Texas create estate plans that protect every member of the family -- current spouses, former spouses, biological children, and stepchildren. The conversation isn't always easy, but the plan is always worth it.`,
  ...
  {
    slug: "lady-bird-deeds-texas-estate-planning",
    title:
    ...
    readTime: "3 min read",
    metaDescription:
      "Learn how Lady Bird Deeds work in Texas -- keep control of your home, avoid probate, preserve Medicaid eligibility, and transfer property tax-efficiently.",
    content: `If you own a home in Texas and want to make sure it passes to your family without going through probate, there's a powerful tool you should know about: the **Lady Bird Deed**.
...
Because you retain the right to sell or revoke the deed, a Lady Bird Deed is **not considered a gift** under <a href="/practice-areas/medicaid-planning">Medicaid planning</a> rules. This means:
...
Because the property passes outside of probate, it is generally not subject to the <a href="/practice-areas/medicaid-planning">Texas Medicaid Estate Recovery Program (MERP)</a>. This is one of the most effective ways to protect a homestead from post-death Medicaid claims.
...
A Lady Bird Deed only covers one piece of real property. If you have multiple properties, financial accounts, investment portfolios, or complex family situations, a comprehensive <a href="/practice-areas/estate-planning">trust-based estate plan</a> may be more appropriate. A Lady Bird Deed can work alongside a trust as part of a broader strategy.

## How to Set Up a Lady Bird Deed

Creating a Lady Bird Deed requires:

1. **Drafting the deed** with the correct legal language (the enhanced life estate powers must be explicitly stated)
2. **Signing before a notary** public
3. **Recording the deed** with the county clerk in the county where the property is located

The deed must be recorded during your lifetime to be effective. It does not need to be signed by the beneficiaries.

## Get Professional Help

While Lady Bird Deeds are powerful, the language must be drafted correctly to achieve the intended results. Errors in the deed can create title problems, unintended tax consequences, or Medicaid eligibility issues. At WG Law, we prepare <a href="/practice-areas/real-estate-law">Lady Bird Deeds</a> as part of our <a href="/practice-areas/estate-planning">estate planning services</a> for families across McKinney, Southlake, and North Texas.`,
  },
  {
    slug: "sued-in-texas-what-to-do",
    title:
    ...
    readTime: "4 min read",
    metaDescription:
      "Served with a lawsuit in Texas? Learn the critical deadlines, your rights, and the step-by-step process for responding -- plus common mistakes to avoid.",
    content: `Nobody expects to be served with a lawsuit. But it happens -- and when it does, the worst thing you can do is panic, ignore it, or hope it goes away.
...
If you've been served with a lawsuit in Texas, contact WG Law. We'll review your case, explain your options, and help you build a strong defense.`,
  ...
  {
    slug: "texas-deed-fraud-home-title-theft",
    title: "Your House Can Be Stolen Without a Key: The Truth About Texas Deed Fraud",
    excerpt:
    ...
    content: `<p>Sam Cormier spent forty years building something modest but real: a portfolio of eight paid-off properties in Houston, Texas. Not a tech empire, not a hedge fund -- just eight houses, bought one at a time, with decades of work behind each one. By the time he was 84, those properties were worth about $1.1 million. They were his legacy. His retirement. His gift to his children.</p>

<p>Then one morning he received a letter addressed to someone he had never heard of, sent to an address he owned, informing this stranger of a change in ownership. Sam Cormier had never sold that property. He had never signed a deed. He had never agreed to anything. But someone had visited the Harris County Clerk's office, filed forged deeds on all eight of his properties, and then borrowed $1 million against the titles she had just stolen. When she could not repay the loans, the lender moved to auction his houses. The man who had never needed a mortgage -- because he had always paid cash -- was about to lose everything to a person who had never owned any of it.</p>

<p>This was not an anomaly. It was not a glitch. It was Texas property law working precisely as designed -- and revealing a structural gap that fraudsters across the state had been quietly exploiting for years.</p>

<h2>How Texas Deed Fraud Actually Works</h2>

<p>Texas, like most states, maintains a system of public deed recording. When property changes hands, the deed is filed with the county clerk and entered into the public record. That record then carries a legal presumption of validity: if it is recorded, courts treat it as authentic unless proven otherwise.</p>

<p>For most of Texas history, this system worked fine. The people who knew how to draft a deed, obtain a notarization, and file it with the county were, overwhelmingly, the people with legitimate reasons to do so. Deed fraud required a certain sophistication -- access to legal forms, a cooperative notary, and the boldness to present a fabricated document to a government office.</p>

<p>Then the internet made every piece of that equation trivially easy. Deed templates are free online. Notary fraud is disturbingly common -- some notaries simply stamp whatever is put in front of them for a fee. And Texas county clerks, by law and by long-standing practice, have no obligation to verify that the signature on a deed is genuine. Their job is administrative: accept the document, collect the filing fee, record it. Investigation is not in their job description.</p>

<p>The result is a recording system that is, in the words of one Harris County prosecutor, "an open door." File a deed. Record it. Then use the recorded document -- which carries a presumption of validity -- to borrow money against the property, sell it to an unsuspecting buyer, or simply strip the equity. By the time the original owner discovers what happened, the fraudster has often moved on to the next target.</p>

<h2>The Page-Swap Method: Henry v. Henry</h2>

<p>Fraud rarely requires sophistication when trust is available as a substitute. In <em>Henry v. Henry</em>, No. 02-24-00507-CV (Tex. App.--Fort Worth 2025), an elderly woman named Mozelle owned a ranch that had been in her family for generations. Her son Darrell brought her documents to sign. Mozelle signed. She trusted her son.</p>

<p>A forensic document examiner later testified that the pages describing the ranch property were almost certainly not attached to the first page of the document when Mozelle put her pen to paper. She signed a signature page. Darrell then inserted the property description pages afterward. The completed deed -- bearing Mozelle's genuine signature on page one and Darrell's chosen property description on the pages that followed -- was filed with the county clerk and recorded without incident. Darrell subsequently sold 70 acres of the ranch for $257,151.</p>

<p>The estate of Mozelle Henry sued. The trial court found the deed fraudulent. The Fort Worth Court of Appeals affirmed the forgery finding in 2025. Darrell lost the legal fight. But the case also exposed something the victim's family found deeply frustrating: even when fraud is proven, recovering every dollar of damage in Texas is complicated. The appeals court reversed part of the damages award because, under Texas law, being someone's adult son does not automatically create a legal fiduciary relationship -- and without that formal fiduciary duty, certain categories of damages are simply unavailable, no matter how egregious the conduct. The law can find the fraud and still leave the victim holding part of the bill.</p>

<h2>The Legal Twist That Shocks Every Homeowner</h2>

<p>Deep inside Texas property law is a distinction that sounds academic until it happens to you. Texas courts divide fraudulent deeds into two categories: <strong>void</strong> and <strong>voidable</strong> -- and the difference between them can determine whether you get your house back.</p>

<p>A <strong>forged deed</strong> -- one where the owner's signature was fabricated entirely without their participation, as in the Cormier case -- is <em>void ab initio</em>. Void from the beginning. It conveys nothing. No matter how many times a forged deed is bought and sold afterward, it never transfers valid title. In theory, this is a strong protection: if your name was forged, you remain the legal owner regardless of what the public records say.</p>

<p>In practice, "in theory" does a lot of heavy lifting. Proving forgery requires a lawsuit -- which requires an attorney, court filings, expert witnesses, and years of litigation. While that lawsuit proceeds, the fraudulent deed sits in the public record, clouding your title. You cannot easily sell or refinance. If the fraudster has already sold to a third party who paid fair market value and had no knowledge of the fraud, that innocent buyer is also a victim -- and both of you now have competing claims to the same house.</p>

<p>A <strong>fraudulently induced deed</strong> -- where the real owner was deceived into signing, as when someone misrepresents what a document says -- is only <em>voidable</em>. The owner can ask a court to set it aside. But here is the catch: an innocent third-party buyer who purchased for fair value without knowledge of the fraud may have enforceable rights that compete with the original owner's claim. Texas's bona fide purchaser doctrine provides real protection to good-faith buyers in the voidable context.</p>

<p>The practical result is that deed fraud victims -- whether they were forged or deceived -- almost always end up in prolonged, expensive litigation with no guaranteed outcome. The law recognizes the wrong. Recovering from it is another matter entirely.</p>

<h2>The Scale of the Problem in Texas</h2>

<p>Sam Cormier's story is dramatic, but it is not unique. In Harris County, a single deed fraud operation required the return of 40 properties to their rightful owners before prosecutors could stop it. In Dallas-Fort Worth, WFAA's investigative team documented a fraudster who continued filing fake deeds on North Texas properties from his prison cell -- after conviction -- because nothing in the recording system prevented it. The FBI's Internet Crime Complaint Center tracked nearly 1,500 Americans over age 60 who lost a combined $65 million to real estate fraud in a single recent year.</p>

<p>The title insurance industry, which quietly absorbs enormous amounts of this risk, paid $502.9 million in claims in the first nine months of 2024 alone. The American Land Title Association estimates that roughly 25 percent of all U.S. real estate transactions contain some title defect that must be found and cured before closing -- in most cases without the buyer or seller ever knowing a problem existed.</p>

<p>In Texas, the targets are disproportionately elderly homeowners with paid-off properties. A paid-off house has no lender monitoring the title. There are no monthly mortgage statements that might flag a problem. There is often no one paying close attention to county records. For a fraudster, that combination -- clear title, unmonitored, owned by someone who may not be checking their county clerk portal regularly -- represents an ideal target.</p>

<h2>What Texas Did About It in 2025</h2>

<p>By the time the Texas Legislature convened its 89th session in 2025, deed fraud had become a front-page issue across the state. AARP Texas made it a priority legislative goal, citing the targeting of seniors. The Legislature responded with a package of new laws effective September 1, 2025:</p>

<ul>
  <li><strong>SB 1734</strong> requires county clerks to flag suspected fraudulent deed filings and creates a formal reporting mechanism for title fraud complaints directed to clerk's offices across Texas.</li>
  <li><strong>SB 693</strong> stiffens criminal penalties for fraudulent property filings, elevating certain deed fraud offenses and adding mandatory minimum consequences that make prosecution a more meaningful deterrent.</li>
  <li><strong>SB 16</strong> authorizes -- but does not require -- counties to implement identity verification at the point of filing. Individual counties must opt in. Harris County moved quickly. Many others have not yet acted.</li>
</ul>

<p>These are genuine improvements. But they are not a complete solution. SB 16's verification program is voluntary, meaning the level of protection across Texas's 254 counties will remain uneven for years. And all three new laws are primarily reactive: they address what happens after fraud is attempted or discovered. The foundational vulnerability -- that Texas's recording system is open, presumption-based, and historically unverified -- remains structurally intact.</p>

<h2>What Every Texas Homeowner Can Do Right Now</h2>

<p>The best protection available to most Texas homeowners today is not a new law. It is a combination of vigilance, professional guidance, and a few concrete actions that take minutes to set up:</p>

<ul>
  <li><strong>Sign up for property alert monitoring.</strong> Most Texas counties now offer free alerts when any document referencing your property address or name is filed. Collin County homeowners can register through the county clerk's website. Dallas County residents can use the Dallas Central Appraisal District's monitoring tools. This does not prevent fraud -- but it provides early warning before equity is stripped.</li>
  <li><strong>Check your county records annually.</strong> Visit your county clerk's online portal, search for your name and property address, and look for any deeds, liens, or instruments you did not authorize. Ten minutes, once a year.</li>
  <li><strong>Confirm your homestead exemption is on file.</strong> Texas's constitutional <a href="/practice-areas/estate-planning">homestead protections</a> create additional legal barriers around your primary residence and limit the types of liens that can attach to it. Make sure your exemption is filed with your county appraisal district -- and note that recent Texas legislation may require some homeowners to renew their exemption on file.</li>
  <li><strong>Understand what your title insurance actually covers.</strong> Owner's title insurance, purchased at closing, protects against defects in title that existed at the time of your purchase. It does not cover post-closing fraud. If you purchased only a lender's policy, you may have no personal protection at all. Talk to a <a href="/practice-areas/real-estate-law">Texas real estate attorney</a> about your specific situation.</li>
  <li><strong>Review your estate planning documents.</strong> Many deed fraud victims are elderly Texans whose powers of attorney were drafted decades ago without modern safeguards. An overly broad or outdated power of attorney can give a bad actor legal cover to transfer property. A current, carefully drafted durable power of attorney from a licensed Texas <a href="/practice-areas/estate-planning">estate planning attorney</a> limits this exposure considerably.</li>
  <li><strong>Act immediately if you suspect fraud.</strong> Time is not neutral in these cases. Filing a suit to quiet title or void a fraudulent deed is time-sensitive. Evidence disappears. Fraudsters move assets. The longer a fraudulent deed sits in the public record without challenge, the more complicated the clearing process becomes -- and the greater the risk that an innocent third-party buyer enters the picture with competing rights.</li>
</ul>

<h2>The Promise at the Core of Property Law</h2>

<p>Sam Cormier eventually recovered most of his properties. The fight required the intervention of Harris County prosecutors, civil attorneys, and ultimately the courts. It took years. He was lucky, in the way that survivors of something terrible are described as lucky -- meaning they endured something they never should have been subjected to in the first place.</p>

<p>Most deed fraud victims in Texas do not get that outcome. They get prolonged litigation, legal bills they cannot absorb, and in some cases, property that has already been sold to an innocent third party who also has legitimate rights to it. The system that was supposed to guarantee the security of their title -- one of the oldest promises of American property law -- turned out to have a door that almost anyone could open.</p>
...
<p><em>This article provides general legal information about Texas law and is not legal advice. Every situation is different. If you have questions about a specific estate, debt, or probate matter, please consult a licensed Texas attorney.</em></p>`,
  ...
  {
    slug: "how-to-protest-property-taxes-texas-2026",
    title: "How to Protest Your Texas Property Taxes Before the May 15 Deadline",
    excerpt:
    ...
    readTime: "8 min read",
    metaDescription:
      "Your Texas property appraisal notice just arrived. Here's how to protest before May 15 — and why most DFW homeowners who fight their tax bill actually win.",
    content: `<p>In the spring of 2024, two neighbors on the same cul-de-sac in Frisco, Texas, opened nearly identical envelopes from the Collin Central Appraisal District. Inside each was a Notice of Appraised Value showing their homes — built the same year, same floor plan, same zip code — had jumped to $698,000, up from $545,000 the year before. For Carlos Medina, the notice went into the recycling bin. He'd heard you couldn't fight the appraisal district. He paid the tax bill in January, muttering about it over the backyard fence.</p>

<p>His neighbor, Lisa Kowalski, spent forty minutes on the Collin CAD website filing a protest online. She brought two comparable sales from two streets over — houses with the same square footage that had sold for $647,000 and $651,000. At her informal hearing in May, a district appraiser reviewed the comps and reduced her appraised value to $648,000. Her tax savings: just over $1,900 for the year.</p>

<p>Carlos didn't lose a lawsuit. He didn't make a mistake on a form. He simply didn't know he had the right to push back — and that most Texans who do push back, win. Over five years of not protesting, while the appraisal cap compounded from a higher base, Carlos would leave more than $9,000 on his kitchen table.</p>

<p>This story plays out in neighborhoods across McKinney, Plano, Allen, and Frisco every single spring. And the numbers behind it are staggering: in 2025, <strong>71% of DFW homeowners did not file a property tax protest</strong>. They assumed the appraisal district's number was the number. It isn't.</p>

<h2>The Right You Didn't Know You Had</h2>

<p>Under the Texas Property Tax Code — Chapter 41 — every property owner has the legal right to protest their appraised value to the Appraisal Review Board (ARB) each year. You don't need an attorney to file. You don't need specialized knowledge. You need one thing: a Notice of Protest filed before the deadline.</p>

<p>The deadline for 2026 is <strong>May 15, 2026</strong>, or 30 days after your Notice of Appraised Value is mailed — whichever is later. If you haven't received your notice yet, check your appraisal district's online portal. Collin CAD, Denton CAD, and Dallas CAD all allow online filing, and most will send email alerts once notices go out.</p>

<p>Here's what most homeowners don't realize: you're not contesting the government's authority to tax your property. You're contesting whether the <em>number</em> they assigned is accurate. The appraisal district uses mass appraisal models to value hundreds of thousands of properties at once. Those models make mistakes. They don't know about the foundation crack in your garage, the traffic noise from the new highway behind your fence, or the fact that your kitchen still has laminate countertops while every comparable sale in their model had a full gut renovation.</p>

<h2>Why You're More Likely to Win Than You Think</h2>

<p>In 2025, between 60% and 80% of Texas property tax protests resulted in a value reduction. In Dallas County, the informal review stage resolved the vast majority of cases with an 84% success rate at that first step alone. Statewide, homeowners who filed and followed through saved an average of $1,945 per year. In Collin County specifically, the average reduction in appraised value was $25,624.</p>

<p>Read that last number again. Twenty-five thousand dollars in appraised value, gone — because someone filed a form and showed up to a meeting.</p>

<p>A homeowner who protests every year for five years, saving a modest $1,200 annually, keeps $6,000 more than their neighbor who stays silent. And because of how the 10% homestead cap compounds, the gap widens every year. Once you let your appraised value climb unchallenged, you're starting from a higher base the following year — and the year after that.</p>

<h2>The Step Most People Skip: The Informal Hearing</h2>

<p>When you file a protest, most appraisal districts will schedule you for an <strong>informal review</strong> first — a brief meeting with a district appraiser before your formal ARB hearing. This is where the vast majority of Texas property tax protests actually get resolved, and it's the step that most homeowners don't know about.</p>

<p>The informal review is not adversarial. You sit across from a staff appraiser — often over video or phone now — present your evidence, and they have authority to adjust your value on the spot. No board. No courtroom drama. No formal presentation. Just a conversation, backed by data.</p>

<p>If the informal review doesn't resolve your case to your satisfaction, you proceed to a formal ARB hearing. The ARB is an independent panel — not employees of the appraisal district — that hears your evidence and the district's evidence and makes a determination. You have the right to cross-examine the district's witnesses and to see their evidence package before the hearing date.</p>

<h2>How to Build Your Case: What Evidence Actually Works</h2>

<p>The most powerful evidence in a Texas property tax protest is <strong>comparable sales data</strong> — proof that similar homes in your neighborhood sold for less than your appraised value. Here's how to find and use it effectively:</p>

<ul>
  <li><strong>Pull comparable sales from public records.</strong> The appraisal district's own property search tool is your starting point. Look for sales within a half-mile radius, with similar square footage (within 15%), similar age, and similar condition — sold within the last six to twelve months.</li>
  <li><strong>Adjust for real differences.</strong> If your comparable is slightly larger, note that. If it had an updated kitchen yours doesn't, note that too. The goal is to show the district's model overvalued your home relative to actual market transactions.</li>
  <li><strong>Document condition issues.</strong> Deferred maintenance, foundation problems, drainage issues, proximity to commercial noise or new traffic — these legitimately reduce market value. Bring photos and, where applicable, contractor estimates.</li>
  <li><strong>Request the district's evidence package.</strong> Under Texas law, you can request the appraisal district's own evidence before your formal hearing. Review it carefully — sometimes their own comparable sales support a lower value than they assigned you.</li>
</ul>

<h2>Understanding the 10% Cap — And Why It Doesn't Mean You're Safe</h2>

<p>Here's a concept that trips up many Texas homeowners: the <strong>homestead appraisal cap</strong>. Under Texas Tax Code Section 23.23, if you have a homestead exemption on file, your appraised value cannot increase by more than 10% per year — regardless of what the market actually did.</p>

<p>So if the market value of your home jumped from $500,000 to $650,000 in one year, but your prior appraised value was $500,000, the district can only raise your appraised value to $550,000. The cap protects you — for now.</p>

<p>But here's the critical piece: the appraisal district will still list the full market value ($650,000) on your notice. Over time, as the cap compounds year over year, that gap between market value and appraised value can become enormous. The moment you lose your homestead exemption — because you moved, rented the property out, or the home passed through <a href="/practice-areas/probate">probate</a> to a new owner — the cap disappears entirely. The new owner may suddenly face a tax bill based on the full, uncapped market value.</p>

<p>This is precisely why <strong>even homeowners currently protected by the cap should consider protesting</strong>. You're fighting the market value figure, which is the ceiling your appraised value will keep rising toward. Reducing the market value today limits how far the appraised value can grow — and reduces the tax shock for whoever inherits your home.</p>

<p>This interaction between property tax appraisals and estate planning is something our clients in McKinney and Frisco increasingly ask about. When property transfers through a <a href="/blog/lady-bird-deeds-texas-estate-planning">Lady Bird Deed</a> or a revocable trust, understanding how the cap resets is essential to planning the transfer correctly. At Willingham Law Group, we make sure our clients understand these downstream effects as part of their <a href="/practice-areas/real-estate-law">real estate</a> and <a href="/practice-areas/estate-planning">estate planning</a> strategy.</p>

<h2>Don't Leave Your Exemptions on the Table Either</h2>

<p>Before you file a protest, make sure you're taking every exemption you're entitled to. Exemptions and protests are separate processes — and both have deadlines. Exemption applications are generally due <strong>April 30</strong>. Here's what's available:</p>

<ul>
  <li><strong>General Homestead Exemption:</strong> Removes $100,000 from your home's appraised value for school district taxes — the amount was increased under Proposition 4 in 2023. This alone can save hundreds of dollars per year.</li>
  <li><strong>Over-65 Exemption:</strong> An additional $10,000 school district exemption, plus a tax freeze — your school district taxes cannot increase once you qualify, for as long as you own and occupy the home.</li>
  <li><strong>Disability Exemption:</strong> Same $10,000 school district benefit as the over-65 exemption, available to qualifying disabled individuals.</li>
  <li><strong>Veterans Exemptions:</strong> Range from partial exemptions to a 100% exemption for totally disabled veterans, along with surviving spouse protections.</li>
</ul>

<p>If you're 65 or older and haven't filed for the over-65 exemption, do so before April 30. The savings — especially the tax freeze — are among the most powerful protections Texas law offers older homeowners.</p>

<h2>When to Get Professional Help</h2>

<p>For most homeowners protesting a single-family residence, the DIY process is entirely manageable: file online, gather comparable sales, attend the informal meeting. But there are situations where professional representation changes the outcome:</p>

<ul>
  <li><strong>High-value properties</strong> where a small percentage reduction translates to large dollar savings justify the cost of representation</li>
  <li><strong>Commercial or investment properties</strong> that require income-approach or cost-approach valuation analysis beyond simple sales comparisons</li>
  <li><strong>Cases past the informal review</strong> heading to a formal ARB hearing, where understanding the board's rules and cross-examination procedures matters</li>
  <li><strong>District court appeals</strong> — if you disagree with the ARB's final determination, you can appeal to district court within 60 days, but this step absolutely requires a licensed Texas attorney</li>
</ul>

<p>Property tax protest companies — which typically work on contingency, taking a percentage of the savings — can be a reasonable option for homeowners who don't want to handle the process themselves. For complex matters that reach district court, or where the protest intersects with a real estate transaction, trust, or probate proceeding, an attorney familiar with Texas property law is the right call.</p>

<h2>Back on the Cul-de-Sac in Frisco</h2>

<p>Carlos Medina eventually learned what his neighbor Lisa had done. By the time he filed his first protest — three years after that original notice — his appraised value had climbed to $731,000 under the compounding cap, starting from the unchallenged high. Lisa's, meanwhile, sat at $683,000 — still rising, but from a lower base.</p>

<p>At his first informal hearing, Carlos brought comparable sales and a contractor's estimate for some deferred foundation work. His appraiser — polite, professional, nothing like the bureaucratic wall he'd imagined — reduced his value by $38,000. His property tax bill dropped by more than $1,000 that year.</p>

<p>"I didn't know I could do this," he said afterward. He's filed every year since.</p>

<p>That's the thing about the Texas property tax protest process. It isn't hidden. It's a legal right, codified in the Texas Property Tax Code, documented on the appraisal district's own website, and used successfully by hundreds of thousands of Texas homeowners every year. The system works — for the people who use it. Most Texans simply never try.</p>

<p>If your Notice of Appraised Value hasn't arrived yet, it will. When it does, don't throw it in the recycling bin. You have until May 15, 2026, to file a protest. Forty minutes, a few comparable sales, and one informal conversation with an appraiser might be the most profitable afternoon you spend this spring.</p>

<p><strong>Have questions about how your property appraisal interacts with your estate plan, a pending real estate transfer, or a probate matter? <a href="/practice-areas/real-estate-law">Contact Willingham Law Group</a> — serving McKinney, Frisco, Plano, and the greater Dallas-Fort Worth area.</strong></p>

<p><em>This article is for general informational purposes only and does not constitute legal advice. Property tax laws, deadlines, and exemption requirements change regularly. Consult a licensed Texas attorney or certified tax professional for guidance specific to your situation.</em></p>`,
  },
  {
    slug: "how-long-does-probate-take-texas",
    title: "How Long Does Probate Take in Texas?",
    excerpt:
    ...
    readTime: "9 min read",
    metaDescription:
      "How long does probate take in Texas? Independent administration typically takes 6–12 months. Learn the four paths, the creditor period timeline, and what causes delays.",
    content: `<p>When Robert's mother died in Frisco last spring, a neighbor who had been through probate in California warned him it would take at least two years. Robert braced for that. He arranged his finances around a long wait. He told his siblings not to expect anything soon.</p>

<p>Seven months after his mother's death, the estate was fully administered. The house had been transferred. The savings account had been distributed. The final accounting had been filed with the Collin County probate court and accepted without comment.</p>

<p>The neighbor had not been lying about California. But Texas is not California. The state has built one of the most executor-friendly probate systems in the country — with streamlined procedures, minimal court intervention, and a legal framework designed to move assets to families quickly rather than to generate court proceedings. For most uncomplicated estates, Texas probate is measured in months, not years.</p>

<p>The real variable is which of several available legal paths an estate qualifies for. Choose the right one, and the process is straightforward. Choose the wrong one, or stumble into it without understanding your options, and the timeline grows considerably. Here is what actually determines how long probate takes in Texas.</p>

<h2>Why Texas Probate Has a Reputation for Moving Quickly</h2>

<p>In most states, probate means months of mandatory court supervision, judicial approval at every step, and professional fees that accumulate throughout. Texas took a different approach. The state's default probate mechanism — called <strong>independent administration</strong> — gives the executor sweeping authority to settle the estate without seeking court approval for each individual action. Once the court appoints the executor and issues letters testamentary, the executor can pay creditors, sell property, manage accounts, and distribute assets largely on their own timeline.</p>

<p>This design makes Texas probate dramatically faster than states where courts must approve every transaction. The primary constraint on Texas probate timelines is not judge availability or court procedures — it is the mandatory waiting periods built into Texas law to protect creditors and missing heirs.</p>

<h2>The Four Main Paths for Settling a Texas Estate</h2>

<p>Texas offers several distinct legal mechanisms for transferring assets at death. The right choice depends on the size of the estate, whether there is a valid will, and what assets are involved.</p>

<h3>1. Muniment of Title: The Fastest Court-Based Process (4–8 Weeks)</h3>

<p>If a Texas decedent left a valid will and has no outstanding debts — other than mortgage liens on specific property — the estate may qualify for muniment of title under <strong>Texas Estates Code §257.001</strong>. This is not a full probate. There is no executor appointed, no creditor waiting period, and no ongoing administration. Instead, the will itself is admitted to court as a title document, and the court issues an order that transfers title directly to the beneficiaries named in the will.</p>

<p>The entire process typically takes four to eight weeks: a couple of weeks to prepare the application and schedule a hearing, and then the court issues its order. That order is then recorded with the county clerk to transfer real property. Muniment of title is genuinely fast — but it only works when there are truly no unsecured debts outstanding. If any exist, the estate needs a process that includes a formal creditor period.</p>

<h3>2. Independent Administration: The Standard Texas Probate (6–12 Months)</h3>

<p>Independent administration is what most people mean when they talk about Texas probate. It is the default procedure when a will exists — and it handles the vast majority of Texas estates. Under <strong>Texas Estates Code §401.001</strong>, an executor named in the will is typically granted independent administration authority, meaning the court's role largely ends after the initial hearing.</p>

<p>For a typical estate — a house, bank accounts, some personal property, no major creditor disputes — independent administration takes six to twelve months from start to finish. The single biggest driver of that timeline is the mandatory four-month creditor period, which cannot be shortened regardless of how efficiently the executor moves.</p>

<h3>3. Small Estate Affidavit: No Court Appearance Required (2–6 Weeks)</h3>

<p>For estates where the total value of assets — excluding the homestead and exempt property — does not exceed $75,000, and where there is no will (or the will has not been admitted to probate), Texas offers the small estate affidavit under <strong>Texas Estates Code §205.001</strong>. This procedure requires no court hearing. The heirs sign a sworn affidavit identifying the assets and debts, have it notarized, and present it directly to financial institutions — or record it with the county clerk for real property.</p>

<p>Processing time is largely administrative: a few weeks from signature to having assets in hand. The limitation is the $75,000 cap and certain restrictions on when the procedure is available.</p>

<h3>4. Dependent Administration: Court-Supervised, Longer (1–3 Years)</h3>

<p>Dependent administration requires judicial approval for each significant action — selling property, paying large debts, distributing assets. It is typically only used when the will requires it, when heirs cannot agree on an independent executor, or when there is a dispute about the estate.</p>

<p>Because each action requires a court hearing, dependent administration is substantially longer and more expensive than independent administration. Contested matters, valuation disputes, and crowded court dockets can stretch the process to two years or more. This is the procedure that generates the horror stories about probate — but in Texas, it is the exception, not the rule.</p>

<h2>A Typical Independent Administration: Step by Step</h2>

<p>Understanding how independent administration unfolds in practice helps set realistic expectations. Using Collin County as an example — Dallas and Denton County timelines are similar — here is how the process typically moves.</p>

<h3>Filing and the Initial Hearing (Weeks 1–3)</h3>

<p>The process begins when the executor files an application to probate the will with the county court at law. The application includes the original will, a death certificate, and basic information about the estate's assets and heirs. Most Texas probate courts schedule hearing dates two to three weeks after filing. At the hearing — which typically lasts fifteen to thirty minutes — the judge examines the will, confirms it meets Texas requirements, and issues an order admitting it to probate. The clerk then issues <strong>letters testamentary</strong>: the official documents that authorize the executor to act on behalf of the estate.</p>

<h3>The Mandatory Creditor Period (Months 1–5)</h3>

<p>After letters testamentary are issued, the executor must notify creditors. Under <strong>Texas Estates Code §308.051</strong>, the executor sends written notice to all known creditors. A notice to creditors is also published in a local newspaper under §308.001, which can bar claims from unknown creditors after the waiting period expires.</p>

<p>From the date written notice is sent, known creditors generally have <strong>four months</strong> to file a claim against the estate. This four-month window is the primary reason independent administration takes at least six months — even if the executor is fully prepared to close the estate sooner, creditors who received notice have the right to file claims within that window.</p>

<h3>Settling Debts and Managing Assets (Months 2–6)</h3>

<p>While the creditor period runs, the executor is actively working. Real property is retitled or sold. Financial accounts are consolidated. Personal property is inventoried. An inventory and appraisement of estate assets is filed with the court. Final income tax returns are prepared for the decedent. Any estate tax obligations are assessed — though federal estate taxes only apply to estates exceeding the applicable federal exemption, which for 2024 was $13.61 million per person.</p>

<h3>Distribution and Closing (Months 6–12)</h3>

<p>Once the creditor period has run and all valid claims have been paid or resolved, the executor distributes the remaining assets to beneficiaries according to the will. For most Texas estates, this is the home stretch — transferring accounts, recording deeds, and formally winding down administration. The estate is then closed, either by filing a closing report or by the executor providing notice that administration is complete.</p>

<p>For a routine estate, the entire process — from filing to closing — typically takes <strong>six to nine months</strong>. Estates with real property in multiple counties, business interests, or a larger number of creditors routinely take ten to fourteen months.</p>

<h2>What Makes Texas Probate Take Longer</h2>

<p>Even under independent administration, certain circumstances predictably extend the timeline:</p>

<ul>
  <li><strong>Will contests.</strong> When a beneficiary or potential heir challenges the validity of the will — claiming undue influence, lack of testamentary capacity, or fraud — the probate is effectively paused until the contest is resolved. Will contests can add one to three years to the process.</li>
  <li><strong>Out-of-state real property.</strong> If the decedent owned real estate in another state, an ancillary probate proceeding is required in that state — running parallel to the Texas proceeding and subject to that state's timeline and rules.</li>
  <li><strong>Business interests.</strong> Estates that include ownership interests in a closely held business require professional valuation, and potentially negotiation over buy-sell agreements or partnership interests. Appraisals take time; disputes about value take longer.</li>
  <li><strong>Disputes among heirs.</strong> Even without a formal will contest, disagreements about who should serve as executor, how assets should be divided, or what items are worth can slow every step of the process and generate additional legal proceedings.</li>
  <li><strong>Missing beneficiaries or unknown creditors.</strong> When the executor cannot locate a beneficiary or is uncertain whether all creditors have been identified, the estate may need to stay open longer to protect against future claims.</li>
  <li><strong>Court docket congestion.</strong> In high-volume counties like Dallas, Tarrant, and Harris, hearing dates may be harder to schedule than in Collin or Denton County. The difference is typically measured in weeks rather than months, but it adds up.</li>
</ul>

<h2>The Deadline You Cannot Miss: Four Years From Death</h2>

<p>Texas Estates Code §256.003 requires that an application to probate a will must be filed within <strong>four years of the decedent's death</strong>. Miss that deadline and the will generally cannot be admitted to probate — leaving the estate to be distributed as if the person had died without a will, according to Texas's intestacy statutes.</p>

<p>Four years sounds like a long time, and for most families it is. But for families navigating complicated grief, unresolved family conflict, or estates where no one wants to take responsibility for starting the process, those years can pass faster than expected. There is no benefit to waiting — and several significant risks.</p>

<h2>Planning Ahead to Make Probate Faster and Simpler</h2>

<p>The length of probate is not only determined by what happens after death — it is largely shaped by what planning was done before. Estates with clear, current estate plans and coordinated beneficiary designations are faster and simpler to settle. Specific tools that reduce or eliminate probate delays include:</p>

<ul>
  <li><strong>Beneficiary designations</strong> on life insurance, retirement accounts, and payable-on-death bank accounts — these assets pass directly to named individuals without probate, often within days of presenting a death certificate.</li>
  <li><strong>Lady Bird deeds</strong> (enhanced life estate deeds) that allow real property to transfer automatically at death without triggering a probate proceeding. Texas is one of only a handful of states that recognizes this deed type.</li>
  <li><strong>Revocable living trusts</strong> that hold the estate's core assets and distribute them at death according to the trust's terms — no court, no creditor waiting period, no letters testamentary required.</li>
  <li><strong>Transfer-on-death deeds</strong> for real property, which accomplish a similar result to a Lady Bird deed and became widely available in Texas through the Texas Real Property Transfer on Death Act.</li>
</ul>

<p>These tools can reduce the estate subject to probate to a fraction of total assets, making the entire process faster, less expensive, and far less stressful for the family left behind. They also address situations — such as incapacity before death — that probate cannot touch at all.</p>

<h2>Get the Timeline Right From the Start</h2>

<p>The difference between a six-week muniment of title and a fourteen-month independent administration is not luck — it is preparation, the right legal approach chosen from the beginning, and an attorney who understands the options. For families in Frisco, Plano, McKinney, Allen, and across the Dallas-Fort Worth Metroplex, the Collin, Denton, and Dallas County probate courts are well-staffed and predictable. Most routine estates move on schedule.</p>

<p>At <a href="/contact">Willingham Law Group</a>, we help executors understand which probate process fits their estate, set a realistic timeline, and navigate the creditor period and court requirements efficiently. Whether you are administering an estate now or planning ahead to make things simpler for your family, our <a href="/practice-areas/probate">probate practice</a> is here to help.</p>
